# Generated by Powerlevel10k configuration wizard on 2022-11-02 at 22:07 IST.
...
# angled separators, round heads, sharp tails, 2 lines, disconnected, full frame,
...
function prompt_my_tux_icon() {
	p10k segment -i $'\uf17c' -f 256
}
