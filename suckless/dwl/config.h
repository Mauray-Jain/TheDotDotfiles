...
static const char *const autostart[] = {
	"/home/mauray/.config/dwl/autostart.sh", NULL,
	NULL /* terminate */
};
...
static const Key keys[] = {
	...
	/* Screenshot */
	{ MODKEY,                                       XKB_KEY_s,                      spawn,                   SHCMD("slurp | grim -g - - | tee ~/Pictures/Screenshots/\"Screenshot From $(date +'%F %H-%M-%S')\".png | wl-copy") },
	{ 0,                                            XKB_KEY_Print,                  spawn,                   SHCMD("grim - | tee ~/Pictures/Screenshots/$(date +%s).png | wl-copy") },
	...
	{ MODKEY|WLR_MODIFIER_SHIFT|WLR_MODIFIER_CTRL,  XKB_KEY_S,                      spawn,                   {.v = shutdown} },
	{ MODKEY|WLR_MODIFIER_SHIFT,                    XKB_KEY_S,                      spawn,                   {.v = suspend} },
	{ MODKEY|WLR_MODIFIER_SHIFT,                    XKB_KEY_R,                      spawn,                   {.v = restart} },
